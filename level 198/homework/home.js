// HashMap - გაერთიანებული დავალება

// HashMap არის Java-ს მონაცემთა სტრუქტურა, რომელიც ინახავს მონაცემებს
// Key-Value წყვილების სახით. მონაცემები ინახება ჰეშირების (Hashing)
// მექანიზმის გამოყენებით, სადაც თითოეულ Key-ს შეესაბამება კონკრეტული Value.
//
// Key არის უნიკალური იდენტიფიკატორი, რომლის საშუალებითაც ვპოულობთ მონაცემს,
// ხოლო Value არის მნიშვნელობა, რომელიც დაკავშირებულია ამ Key-სთან.
//
// HashMap-ში ერთნაირი Key-ების შენახვა არ შეიძლება, რადგან თითოეული Key
// უნიკალური უნდა იყოს, თუმცა ერთნაირი Value-ების შენახვა შესაძლებელია.
//
